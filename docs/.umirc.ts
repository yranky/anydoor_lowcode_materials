...
const productPath = `/anydoor_lowcode_materials@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('anydoor_lowcode_materials', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'anydoor_lowcode_materials': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
